...
const MARKET = "ETHYTEST.USD";
const CHANNEL = `public.orderbook.increment.${MARKET}`;
const SPAM_DELAY_MS = 5; 

// --- PRICING CONFIG ---
const CENTER_PRICE = 1100;
const PRICE_RANGE = 100; // +/- $10
          ...
          if (msg.id === 1 && msg.connect) {
              ...
              socket.setInterval(function() {
                  ...
                  const payload = {
                      ...
                      "amount": "0.0001", "price": rawPrice.toFixed(2), "type": "limit", "time_in_force": "gtc"
                  };
